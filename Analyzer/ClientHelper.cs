...
namespace Analyzer
{
	public class ClientHelper
	{
		#error 
		// Enter ServiceKey
		public const string CognitiveServiceKey = "";
		readonly VisionServiceClient visionClient = new VisionServiceClient(CognitiveServiceKey);
		...
		public async Task<List<ClientModel>> GetImageDescription(Stream imageStream,List<ClientModel> clientModelList)
		{
			...
			AnalysisResult result =  await visionClient.AnalyzeImageAsync(imageStream, features.ToList(), null);
